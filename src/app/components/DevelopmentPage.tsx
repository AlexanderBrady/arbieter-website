...
export function DevelopmentPage() {
  const services = [
    ...
    },
    {
      ...
      description:
        "Scalable cloud infrastructure and services for modern, distributed applications.",
    ...
    },
    {
      ...
      description:
        "Robust, secure APIs and microservices architecture for seamless system integration.",
  ...
  const portfolio = [
    {
      ...
      description:
        "Full-stack project management solution with real-time tracking and AI-powered scheduling.",
      image:
        "https://images.unsplash.com/photo-1678344647612-29de50226436?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBvZmZpY2UlMjBidWlsZGluZyUyMGNvbnN0cnVjdGlvbnxlbnwxfHx8fDE3NTUwMjM4OTN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      description:
        "Comprehensive analytics platform for property management and investment analysis.",
      image:
    ...
    },
    {
      ...
      category: "Technology",
      description:
        "Rapid prototyping and MVP development for a SaaS platform with AI capabilities.",
      image:
  ...
  const process = [
    ...
    },
    {
      ...
      description:
        "UI/UX design and system architecture planning with scalability and security in mind.",
      duration: "2-3 weeks",
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description:
        "Production deployment, performance optimization, and ongoing maintenance support.",
      duration: "Ongoing",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "The development team delivered a robust platform that transformed our project management. Excellent code quality and attention to detail.",
      rating: 5,
    },
    {
      name: "Lisa Wang",
      ...
      content:
        "Professional, efficient, and results-driven. They understood our vision and delivered beyond expectations.",
      rating: 5,
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                ...
                mobile apps, and cloud-native architectures for modern
                enterprises.
              </p>
