        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Our commitment to transparency, privacy, and compliance. Find all legal information and policies governing our services.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <section id="privacy" className="scroll-mt-32">
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <div>
                ...
                <p>You have the right to access, update, or delete your personal information. You may also object to certain processing activities. Contact us to exercise these rights.</p>
              </div>
            </div>
          </section>
          ...
          <section id="terms" className="scroll-mt-32">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">Terms of Service</h2>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <div>
                ...
                <p>By accessing or using our services, you agree to be bound by these Terms of Service and our Privacy Policy. If you disagree with any part of these terms, you may not access our services.</p>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">2. Description of Services</h3>
                <p>Arbieter provides AI consulting, development, and integration services. We help businesses identify, implement, and optimise AI solutions tailored to their specific needs.</p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>Not use our services for illegal or unauthorised purposes</li>
                </ul>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">4. Intellectual Property</h3>
                <p>All content, features, and functionality of our services are owned by Arbieter and are protected by copyright, trademark, and other intellectual property laws.</p>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">5. Limitation of Liability</h3>
                <p>To the maximum extent permitted by law, Arbieter shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services.</p>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">6. Termination</h3>
                <p>We may terminate or suspend your access to our services immediately, without prior notice, for any reason whatsoever, including breach of these Terms.</p>
              </div>
          ...
          <section id="cookies" className="scroll-mt-32">
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <div>
                ...
                <p>Cookies are small text files that are stored on your computer or mobile device when you visit our website. They help us provide you with a better experience by remembering your preferences and understanding how you use our site.</p>
              </div>
              ...
              <div>
                ...
                <p>We may use third-party services such as Google Analytics that set their own cookies. These cookies are governed by the respective third-party privacy policies.</p>
              </div>
            </div>
          </section>
          ...
          <section id="gdpr" className="scroll-mt-32">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold">GDPR Compliance</h2>
            </div>
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <div>
                ...
                <p>Arbieter is committed to protecting your personal data in accordance with the General Data Protection Regulation (GDPR). We ensure that your data is processed lawfully, fairly, and transparently.</p>
              </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Legal Basis for Processing</h3>
              ...
              <div>
                ...
                <p>We retain personal data only for as long as necessary to fulfil the purposes for which it was collected, comply with legal obligations, and resolve disputes.</p>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-4">Contact Our Data Protection Officer</h3>
                <p>If you have any questions about our GDPR compliance or wish to exercise your rights, please contact our Data Protection Officer at: <a href="mailto:dpo@arbieter.com" className="text-primary hover:underline">dpo@arbieter.com</a></p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-primary/5 rounded-2xl p-8">
            ...
            <p className="text-muted-foreground mb-6">
              If you have any questions about these policies or need clarification on how we handle your data, please don't hesitate to contact us.
            </p>
            <Button 
