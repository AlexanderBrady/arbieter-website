  ...
  const consultingProcess = [
    {
      ...
      details:
        "We begin with an in-depth analysis of your current workflows, pain points, and business objectives. Through detailed discussions with your team, we identify specific areas where AI can create the most impact.",
      icon: Search,
      outcomes: [
    ...
    },
    {
      ...
      details:
        "Our experts map out specific AI solutions that align with your business needs. We evaluate feasibility, potential ROI, and integration requirements to ensure practical implementation.",
      icon: Map,
      outcomes: [
    ...
    },
    {
      ...
      details:
        "We deliver a comprehensive roadmap with phased implementation, realistic timelines, budget estimates, and projected return on investment to guide your AI transformation journey.",
      icon: Route,
      outcomes: [
  ...
  const benefits = [
    {
      ...
      title: "Proven ROI",
      description:
        "Our consulting approach has delivered an average 300% ROI for clients within the first year.",
    },
    {
      icon: Users,
      title: "Expert Team",
      description:
        "Work directly with AI specialists who have implemented solutions across multiple industries.",
    },
    {
      icon: Clock,
      title: "Fast Results",
      description:
        "From initial consultation to actionable roadmap in just 2-3 weeks.",
    },
    {
      icon: Target,
      title: "Tailored Solutions",
      description:
        "Every recommendation is specifically designed for your business, industry, and team.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                We work with you to identify the AI solutions your business
                actually needs, not just what&apos;s trendy. From lead-chasing
                chatbots to internal copilots and process automation, our
                consulting process starts with understanding your workflows and
                ends with actionable, measurable solutions.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              A structured approach to identifying and implementing AI solutions
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="text-center p-6 bg-background hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Real businesses achieving measurable improvements through our
              consulting process.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center bg-background rounded-2xl p-12 shadow-lg">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Start with a comprehensive consultation to identify exactly where
              AI can create the most value for your business. No obligations,
